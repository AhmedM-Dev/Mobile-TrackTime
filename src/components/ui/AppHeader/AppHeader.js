  ...
  return (
    <>
      ...
      <Header style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Icon name='md-menu' style={{ color: props.theme.fontColor , top:2}} onPress={() => props.navigation.openDrawer()} />
        </View>

        <View style={{ flex: 8 }}>
          <Title style={{ color: props.theme.fontColor , fontFamily:'cursive' , fontSize:25 , fontWeight:'bold' }}>{props.title}</Title>
        </View>
